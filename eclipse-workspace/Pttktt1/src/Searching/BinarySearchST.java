...
public class BinarySearchST<Key extends Comparable<Key>, Value> {
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) throws IOException{ 
    	...
    	for (String s : bs.keys()) System.out.print(s + " ");
    	System.out.println("\n"+bs.select(6));
    	bs.delete("A");
    	...
    	bs.deleteMax();
    	System.out.println(bs.get("Z"));
    	System.out.println(bs.floor("D"));
    	System.out.println(bs.ceiling("D"));
