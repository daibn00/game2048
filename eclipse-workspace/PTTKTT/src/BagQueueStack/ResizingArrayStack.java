...
public class ResizingArrayStack<Item> implements Iterable<Item> {
	...
	public static void main(String[] args) throws IOException {
		...
		ResizingArrayStack<String> raStack = new ResizingArrayStack<String>();
		...
		for (int i = 0 ; i < str.length; i++) {
			...
			else if (!raStack.isEmpty()) System.out.println(raStack.pop() + " ");
		}
		System.out.println("(" + raStack.size() + " left on stack)");
		br.close();
		fr.close();
	}
}